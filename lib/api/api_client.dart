...
class ApiClient {
  ...
  ApiClient(
    ...
    _authentications['Bearer'] = authentication ?? ApiKeyAuth("header", "Authorization");
  }
  ...
  Future applyAuthHeader({List<QueryParam> queryParams, Map<String, String> headers}) async {
  ...
  dynamic _deserialize(dynamic value, String targetType) {
    try {
      ...
      if (deser == null) {
        throw ApiException.response(500, 'Could not find a suitable class for deserialization');
      }
      return deser(value);
    } catch (e, stack) {
  ...
  // We don't use a Map<String, String> for queryParams.
  // If collectionFormat is 'multi' a key might appear multiple times.
  Future<Response> invokeAPI(String path, String method, Iterable<QueryParam> queryParams, Object body,
      Map<String, String> headerParams, Map<String, String> formParams, String contentType, List<String> authNames,
  ...
  Future _updateParamsForAuth(
      List<String> authNames, List<QueryParam> queryParams, Map<String, String> headerParams) async {
